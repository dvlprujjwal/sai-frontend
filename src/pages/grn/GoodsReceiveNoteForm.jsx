...
import { Form, Input, Select, DatePicker, Button, Row, Col, Watermark } from 'antd';
  ...
  return (
    ...
    <div className="goods-receive-note-form-container">
      ...
      <Form onFinish={onFinish} className="goods-receive-note-form" onValuesChange={handleValuesChange} layout="vertical">
          ...
          {(fields, { add, remove }) => (
            <>
              <Form.Item style={{ textAlign: 'right' }}>
                <Button type="dashed" onClick={() => add()} style={{ marginBottom: 16 }} icon={<PlusOutlined />}>
                  Add Item
                </Button>
              </Form.Item>
        ...
        <Row gutter={24} >
          <Col span={6} >
            <Form.Item label="Generated By :" name="generatedBy">
              <Input />
            </Form.Item>
            <Form.Item label="NAME & SIGNATURE :" name="generatedByNameSignature">
              <Input />
            </Form.Item>
            <Form.Item label="Date & Time" name="generatedByDate">
              <DatePicker showTime style={{ width: '100%' }} />
            </Form.Item>
          </Col>
          <Col span={6} offset={10}>
            <Form.Item label="Received By (Custodian)" name="receivedByCustodian">
              <Input />
            </Form.Item>
            <Form.Item label="NAME & SIGNATURE" name="receivedByName">
              <Input />
            </Form.Item>

            <Form.Item label="Date & Time" name="receivedByDate">
              <DatePicker showTime style={{ width: '100%' }} />
            </Form.Item>
