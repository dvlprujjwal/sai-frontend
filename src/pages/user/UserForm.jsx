  ...
  return (
    <Form form={form} onFinish={onFinish} initialValues={initialValues} layout="vertical">
      <Row gutter={16}>
        ...
        <Col span={8}>
          <Form.Item name="userFirstName" label="User First Name" rules={[{ required: true, message: 'Please enter User First Name' }]}>
            <Input />
          </Form.Item>
        </Col>
      </Row>
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Form.Item name="userLastName" label="User Last Name" rules={[{ required: true, message: 'Please enter User Last Name' }]}>
            <Input />
          </Form.Item>
        </Col>
        <Col span={8}>
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Form.Item name="userType" label="User Type" rules={[{ required: true, message: 'Please enter User Type' }]}>
            <Input />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item name="userStatus" label="User Status" rules={[{ required: true, message: 'Please enter User Status' }]}>
            <Input />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item name="privileges" label="Privileges" rules={[{ required: true, message: 'Please enter Privileges' }]}>
            <Input />
          </Form.Item>
        </Col>
      </Row>
