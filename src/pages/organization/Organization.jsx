...
import { fetchOrganizations, updateOrganization, saveOrganization, deleteOrganization } from '../../store/actions/OrganizationActions';
    ...
    <div>
      ...
      <OrganizationTable
        organizations={organizations.filter((organization) =>
          organization.organizationName.toLowerCase().includes(searchText.toLowerCase())
        )}
        onEdit={handleEdit}
      ...
      <Modal
        ...
        footer={null}
      >
        <OrganizationForm onSubmit={handleFormSubmit} initialValues={editingOrganization} />
      </Modal>
    </div>
  );
};
